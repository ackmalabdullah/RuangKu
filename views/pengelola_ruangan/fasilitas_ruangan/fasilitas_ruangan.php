...
// Query untuk menampilkan data fasilitas master
...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="card">
    <h5 class="card-header">Data Fasilitas (Master)</h5>
    <div class="card-body">
          ...
          <tbody>
            ...
            ?>
                <tr>
                  ...
                  <td>
                    <div>
                      <a class="btn btn-warning btn-sm me-1" href="form_fasilitas_ruangan.php?id=<?= $data['id_fasilitas']; ?>">
                        <i class="bx bx-edit-alt me-1"></i> Edit
                      </a>

                      <a class="btn btn-danger btn-sm btn-delete" 
                         href="proses_fasilitas_ruangan.php?aksi=hapus&id=<?= $data['id_fasilitas']; ?>">
