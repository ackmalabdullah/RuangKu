...
$form_action = 'proses_fasilitas_ruangan.php?aksi=tambah';
...
if (isset($_GET['id'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        $_SESSION['pesan'] = ['tipe'=>'danger','isi'=>'Data tidak ditemukan.'];
    ...
    <div class="col-xxl">
      ...
      <div class="card mb-4">
        <div class="card-header d-flex align-items-center justify-content-between">
          ...
          <a href="fasilitas_ruangan.php" class="btn btn-sm btn-secondary">
...
<?php
require '../../../partials/pengelola_lab/footer.php';
?>