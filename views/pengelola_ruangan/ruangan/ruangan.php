...
// --- LOGIKA PENGAMBILAN DATA RUANGAN DENGAN FASILITAS ---

$query = "
    SELECT 
        r.id_ruangan, r.nama_ruangan, r.lokasi, r.kapasitas, r.status_ruangan, r.gambar, 
        kr.nama_kategori,
        
        -- Mengambil semua fasilitas dan jumlahnya ke dalam satu kolom
        GROUP_CONCAT(
            CONCAT(f.nama_fasilitas, ' (', rf.jumlah, ')')
    ...
    FROM 
        ruangan r 
    LEFT JOIN 
        kategori_ruangan kr ON r.kategori_id = kr.id_kategori
    LEFT JOIN 
        ruangan_fasilitas rf ON r.id_ruangan = rf.ruangan_id -- Join ke tabel penghubung
    LEFT JOIN
        fasilitas f ON rf.fasilitas_id = f.id_fasilitas       -- Join ke tabel fasilitas
    
    GROUP BY 
        r.id_ruangan, r.nama_ruangan, r.lokasi, r.kapasitas, r.status_ruangan, r.gambar, kr.nama_kategori
...
<div class="container-xxl flex-grow-1 container-p-y">
  <div class="card">
    ...
    <div class="card-body">
      ...
      <div class="mb-3">
        <a href="form_ruangan.php" class="btn btn-primary">
          <i class="bx bx-plus me-1"></i> Tambah Data Ruangan
        </a>
      </div>
            ...
            ?>
                <tr>
                  ...
                  <td>
                    ...
                    <strong><?= htmlspecialchars($data['nama_ruangan']); ?></strong>
                  </td>

                  <td class="gambar-cell">
                    <?php
                    // ASUMSI PATH GAMBAR: Ubah jika path Anda berbeda
                    $gambar_path = 'assets/img/ruangan/' . htmlspecialchars($data['gambar']);
                  ...
                  <td class="aksi-cell">
                    <div class="d-flex flex-nowrap">
                      <a class="btn btn-warning btn-sm me-1" href="form_ruangan.php?id=<?= $data['id_ruangan']; ?>">
                        <i class="bx bx-edit-alt me-1"></i> Edit
                      </a>

                      <a class="btn btn-danger btn-sm btn-delete"
                        href="proses_ruangan.php?aksi=hapus&id=<?= $data['id_ruangan']; ?>">
              ...
              ?>
              <tr>
                <td colspan="9" class="text-center">Belum ada data ruangan atau lab.</td>
              </tr>
            <?php
            } // Akhir if-else
            ?>
...
<script>
  ...
  deleteButtons.forEach(button => {
    ...
    button.addEventListener('click', function(event) {
      ...
      Swal.fire({
        title: 'Apakah Anda yakin menghapus ruangan ini?',
        text: "Data ruangan yang sudah dihapus tidak dapat dikembalikan!",
        icon: 'warning',
