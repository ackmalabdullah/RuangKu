...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="card">
    <h5 class="card-header">Laporan Data Laboratorium</h5>
    <div class="card-body">

      <div class="mb-3 d-flex gap-2">
        <a href="cetak_pdf_lab.php" class="btn btn-info" target="_blank">
        ...
        <table class="table table-bordered table-hover">
          ...
          <tbody>
            <?php if(mysqli_num_rows($query) > 0){ 
              ...
              <tr>
                <td><?= $no++; ?></td>
                <td><strong><?= $row['nama_lab']; ?></strong></td>
                <td><?= $row['nama_kategori']; ?></td>
                <td><?= $row['kapasitas']; ?></td>
                <td><?= $row['jumlah_komputer']; ?></td>
                <td><?= $row['pic']; ?></td>
              </tr>
            <?php }} else { ?>
              <tr>
