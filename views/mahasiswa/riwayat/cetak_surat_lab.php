...
$query = "
    SELECT 
        ...
        p.jumlah_peserta,
        p.status,
        l.nama_lab AS nama_entitas, /* Mengambil nama_lab */
        l.lokasi AS lokasi,       /* Mengambil lokasi lab */
        m.nama AS nama_mahasiswa,
        m.nim,
        j.nama_prodi AS nama_jurusan 
    FROM peminjaman p
    INNER JOIN laboratorium l ON p.lab_id = l.id_lab /* Join ke tabel laboratorium */
    INNER JOIN mahasiswa m ON p.mahasiswa_id = m.id_mahasiswa 
    INNER JOIN prodi j ON m.prodi_id = j.id_prodi 
    WHERE p.id_peminjaman = ? 
    AND p.mahasiswa_id = ? 
    AND p.status = 'disetujui'
    AND p.lab_id IS NOT NULL /* Memastikan yang dipinjam adalah Lab */
";
...
// =================================================================
// >>> 2. AMBIL NAMA PIMPINAN (PENGELOLA LAB) DARI TABEL USERS <<<
// =================================================================

$nama_pimpinan_lab = "NAMA PENGELOLA LABORATORIUM"; 
$nip_pimpinan_lab = "NIP/NIK BELUM TERCANTUM"; 

$sql_pimpinan = "SELECT nama, username FROM users WHERE role = 'pengelola_lab' LIMIT 1"; /* ROLE: pengelola_lab */
...
if ($result_pimpinan && mysqli_num_rows($result_pimpinan) > 0) {
    ...
    $nama_pimpinan_lab = htmlspecialchars($pimpinan_data['nama']);
    // Menggunakan username sebagai NIP/NIK
    $nip_pimpinan_lab = htmlspecialchars($pimpinan_data['username']); 
}
// =================================================================
...
<head>
    ...
    <title>Surat Peminjaman Laboratorium #<?= $data['id_peminjaman'] ?></title>
    <style>
        /* CSS Dibuat Sangat Rapat Agar Muat 1 Halaman A4 */
        /* 1. KONTROL UKURAN A4 DAN MARGIN (PALING KETAT) */
        @page {
            size: A4;
            margin: 20mm 20mm 20mm 20mm; /* 2cm semua sisi */
        }
        body {
...
<body>
    ...
    <div class="container">
        ...
        <div style="text-align: center; margin-bottom: 10px;"> 
            <p style="font-weight: bold; font-size: 1.1em; margin-bottom: 5px; text-decoration: underline;">SURAT PEMBERITAHUAN PEMINJAMAN LABORATORIUM</p>
            <p style="font-size: 10pt; color: #555; margin: 0;">Nomor: ______ /TI.4 / P.LAB / <?= date('Y') ?></p>
        ...
        <div class="content">
            ...
            <p><strong>Bapak/Ibu Pengelola Laboratorium/Koordinator Lab</strong><br>
            Jurusan Teknologi Informasi<br>
            Di Tempat</p>

            <p style="text-indent: 30px;">Dengan hormat, Bersama surat ini, kami memberitahukan bahwa peminjaman **laboratorium** yang diajukan oleh mahasiswa/i di bawah ini telah **disetujui** oleh pihak Jurusan/Manajemen:</p>
            ...
            <p style="text-indent: 30px; margin-top: 5px;">Adapun detail laboratorium dan waktu peminjaman adalah sebagai berikut:</p>

            <table class="data-table">
                <tr><td>Nama Laboratorium</td><td><strong><?= htmlspecialchars($data['nama_entitas']) ?></strong></td></tr>
            ...
            <p style="text-indent: 30px; margin-top: 5px;">Mohon kiranya Bapak/Ibu Pengelola Laboratorium dapat memberikan akses dan bantuan yang diperlukan sesuai dengan jadwal di atas.</p>
            ...
            <div class="signature">
                ...
                <p style="margin-top: 35px;">
                    <span class="signature-name"><?= $nama_pimpinan_lab ?></span>
                </p>
                <p>Pengelola Laboratorium Jurusan TI</p>
                <p style="margin-top: 5px; font-size: 10pt;">NIP/NIK: <?= $nip_pimpinan_lab ?></p>
            </div>
            ...
            <div class="note no-print">
                ...
                <ol>
                    ...
                    <li>Surat ini harus diserahkan kepada Pengelola Laboratorium saat peminjaman.</li>
                </ol>
