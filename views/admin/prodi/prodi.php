...
$query = mysqli_query($koneksi, "SELECT id_prodi, nama_prodi 
                                 FROM prodi 
...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <div class="mb-3">
        <a href="form_prodi.php" class="btn btn-primary">
          ...
          <tbody>
            ...
            ?>
                <tr>
                  <td><?= $no++; ?></td>
                  <td>
                    <i class="bx bx-book-content fa-lg text-primary me-2"></i>
                    <strong><?= htmlspecialchars($data['nama_prodi']); ?></strong>
                  </td>
                  <td>
                    <div>
                      <a class="btn btn-warning btn-sm me-1" href="form_prodi.php?id=<?= $data['id_prodi']; ?>">
                        <i class="bx bx-edit-alt me-1"></i> Edit
                      </a>

                      <a class="btn btn-danger btn-sm btn-delete" 
                         href="proses_prodi.php?aksi=hapus&id=<?= $data['id_prodi']; ?>">
